...
public class CameraController
{
    ...
    public void UpdateRotation(bool isAiming, Vector2 axis)
    {
        ...
        float xRot = (false/*GameplayManager.Instance.InvertVerticalAxis*/ ? -axis.y : axis.y)
            * currentSensitivity.y * 1.0f/*GameplayManager.Instance.OverallMouseSensitivity*/;

        currentYaw = (false/*GameplayManager.Instance.InvertHorizontalAxis*/ ? -axis.x : axis.x)
